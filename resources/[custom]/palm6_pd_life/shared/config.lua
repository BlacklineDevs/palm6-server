...
-- Interior room posts are now placed with the /placeped tool (client/placer.lua):
-- stand where the NPC goes, spawn a preview, nudge it onto the chair, /pedsave,
-- paste the line here. Cleared the old extraction-guessed posts (they floated /
-- faced wrong) — the lobby + plaza scene above is NTeam's designed scenario data.
Config.Rooms = {
}
