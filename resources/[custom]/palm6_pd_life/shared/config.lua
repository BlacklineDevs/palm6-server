...
Config.Rooms = {
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='officeright', kind='seat', coords=vector4(457.06, -971.71, 33.31, 0.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='officeright', kind='seat', coords=vector4(458.96, -971.71, 33.31, 0.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='officeright', kind='seat', coords=vector4(451.34, -971.71, 33.31, 0.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='officeright', kind='seat', coords=vector4(455.01, -971.71, 33.31, 0.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='officeleft', kind='seat', coords=vector4(458.72, -940.06, 33.31, -180.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='officeleft', kind='seat', coords=vector4(456.82, -940.06, 33.31, -180.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='officeleft', kind='seat', coords=vector4(463.84, -940.06, 33.31, -180.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='officeleft', kind='seat', coords=vector4(461.86, -940.06, 33.31, -180.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='captain', kind='seat', post='captain_desk_1', coords=vector4(477.57, -923.17, 33.34, 0.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='captain', kind='seat', post='captain_desk_2', coords=vector4(477.46, -925.75, 33.35, -180.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='2ndunitoffice', kind='seat', coords=vector4(458.45, -932.12, 37.34, -90.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='2ndunitoffice', kind='seat', coords=vector4(455.87, -932.02, 37.33, 90.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='2ndunitoffice', kind='seat', coords=vector4(477.94, -932.25, 37.40, -90.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='armory', kind='seat', coords=vector4(450.19, -974.23, 29.25, -90.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='armory', kind='seat', coords=vector4(450.19, -976.56, 29.25, -90.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='armory', kind='seat', coords=vector4(444.21, -974.23, 29.25, 90.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='civ', room='mainhall', kind='seat', coords=vector4(454.92, -947.64, 29.25, -90.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='civ', room='mainhall', kind='seat', coords=vector4(457.05, -946.53, 29.25, 0.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='civ', room='mainhall', kind='seat', coords=vector4(457.09, -966.23, 29.25, 0.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='civ', room='mainhall', kind='seat', coords=vector4(450.06, -963.23, 29.25, 0.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='floor', kind='seat', coords=vector4(453.90, -945.10, 33.25, 90.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='floor', kind='seat', coords=vector4(458.36, -945.10, 33.25, 90.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='floor', kind='seat', coords=vector4(457.49, -966.39, 33.25, -90.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='2ndunithall', kind='seat', coords=vector4(463.76, -965.55, 37.25, 0.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='2ndunithall', kind='seat', coords=vector4(463.76, -962.67, 37.25, 0.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='2ndunithall', kind='seat', coords=vector4(463.76, -950.72, 37.25, 0.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='lefthall', kind='seat', coords=vector4(464.91, -931.52, 29.25, 0.0) },
    { scen='PROP_HUMAN_SEAT_CHAIR', ped='cop', room='lefthall', kind='seat', coords=vector4(464.91, -933.57, 29.25, 0.0) },
