...
Nothing enters this folder until it has an **Approved** entry in
`00-FOUNDATION/DECISION-LOG/`. No exceptions. Commercial / sellable assets carry extra
protection and must never bypass the Asset Lifecycle
