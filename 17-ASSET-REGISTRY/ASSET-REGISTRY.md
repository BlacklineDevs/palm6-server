...
| Palm6 System A core identity mark (P6, flat master) | graphic | **Approved** (DEC-007) | Creative Lead | Original work - PALM6 owns (ChatGPT by David) | N | DEC-007 | The primary ownable Palm6 mark: bold varsity **P6** with a palm inside the 6. One-color masters `01-BRAND/logos/core/palm6-p6-black-master.svg` (+ reversed white). Passes 32px/one-color gate. Vaulted. Governs favicon + official use. |
| Palm6 P6 lockup (color, System B) | graphic | Approved (DEC-007) | Creative Lead | Original work - PALM6 owns | N | DEC-007 | Neon/gradient/3D marketing treatment of the P6 mark `01-BRAND/logos/core/palm6-p6-primary.png`. System B lockup for marketing surfaces; not the one-color identity master. |
